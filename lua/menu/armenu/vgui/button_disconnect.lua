...
language.Add( "armenu_disconnect.text", "Are you sure you want to disconnect?" )
language.Add( "armenu_disconnect.yes", "Yes" )
language.Add( "armenu_disconnect.no", "No" )
...
function PANEL:DoClick()
	...
	label:SetText( "#armenu_disconnect.text" )
	...
	yes:SetText( "#armenu_disconnect.yes" )
	...
	no:SetText( "#armenu_disconnect.no" )
...
vgui.Register( "Button_Disconnect", PANEL, "MainMenuButton" )